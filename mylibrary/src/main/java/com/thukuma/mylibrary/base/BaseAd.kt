...
package com.thukuma.mylibrary.base
...
import com.thukuma.mylibrary.helper.CoroutineScopeHandler
...
open class BaseAd(val context: Context) {
    ...
    init {
        if (context is FragmentActivity)
            ...
            TAG, "The supplied Context is not a FragmentActivity instance." +
